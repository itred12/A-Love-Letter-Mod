...
import com.itred.aloveletter.client.EntityRenderer.RendererHelper.vertex
    ...
    override fun render(
        ...
        */
        ...
        for (j in 0..3) {
            ...
            vertex(poseMatrix, normalMatrix, vertexconsumer, -8, -2, 0, 0.0f, 0.0f, 0, 1, 0, pPackedLight)
            vertex(poseMatrix, normalMatrix, vertexconsumer, 8, -2, 0, 0.5f, 0.0f, 0, 1, 0, pPackedLight)
            vertex(poseMatrix, normalMatrix, vertexconsumer, 8, 2, 0, 0.5f, 0.15625f, 0, 1, 0, pPackedLight)
            vertex(poseMatrix, normalMatrix, vertexconsumer, -8, 2, 0, 0.0f, 0.15625f, 0, 1, 0, pPackedLight)
        }
